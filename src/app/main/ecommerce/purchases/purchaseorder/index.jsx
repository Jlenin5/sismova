...
import { getPurchaseOrder, newPurchaseOrder, resetPurchaseOrder, selectPurchaseOrder } from '../store/purchaseorderSlice'
import reducer from '../store'
import PurchaseOrderHead from './PurchaseOrderHead'
...
const PurchaseOrder = (props) => {
  ...
  const product = useSelector(selectPurchaseOrder)
  ...
  useDeepCompareEffect(() => {
    function updateProductState() {
      ...
      if (id === 'new') {
        dispatch(newPurchaseOrder())
      } else {
        dispatch(getPurchaseOrder(Number(id))).then((action) => {
          if (!action.payload) {
            setNoQuote(true)
          }
        })
...
export default withReducer('PurchaseEC', reducer)(PurchaseOrder)