...
import SaleOrderDetailInterface from 'src/app/interfaces/SaleOrderDetailInterface'
...
const ModalSelect = ({open, modalClose, onClose, listProdTable, listProd, onDeleteItem}) => {
  ...
  const [form, setForm] = useState(SaleOrderDetailInterface)
  ...
  useEffect(() => {
    if(listProdTable) {
      ...
      setForm(SaleOrderDetailInterface)
    }
