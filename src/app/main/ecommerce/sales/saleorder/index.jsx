...
import SaleOrderHead from './SaleOrderHead'
...
const SaleOrder = (props) => {
  ...
  const product = useSelector(selectSaleOrder)
  ...
  useDeepCompareEffect(() => {
    function updateProductState() {
      ...
      if (id === 'new') {
        ...
        dispatch(getSaleOrder(Number(id))).then((action) => {
          if (!action.payload) {
            setNoQuote(true)
          }
        })
...
export default withReducer('SalesEC', reducer)(SaleOrder)