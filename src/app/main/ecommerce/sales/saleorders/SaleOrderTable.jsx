...
import SaleOrderTableHead from './SaleOrderTableHead'
import { getSaleOrders, selectSaleOrder, selectSaleOrderSearchText } from '../store/saleordersSlice'
...
const SaleOrderTable = ({
  ...
  useEffect(() => {
    dispatch(getSaleOrders({ page: page + 1, rowsPerPage, searchText:'' })).then((response) => {
  ...
  function handleChangePage(event, value) {
    ...
    dispatch(getSaleOrders({ page: value + 1, rowsPerPage, searchText:'' })).then((response) => {
      setPage(value)
      setData(response.payload.data)
      setLengthPage(response.payload.totalRows)
      setLoading(false)
  ...
  function handleChangeRowsPerPage(event) {
    setLoading(true)
    setPage(0)
    dispatch(getSaleOrders({ page, rowsPerPage:event.target.value, searchText:'' })).then((response) => {
