...
export const { selectAll: selectQuote, selectById: selectQuoteById } =
  quoteAdapter.getSelectors((state) => state.SalesEC.quotes)
...
export const { setQuoteSearchText } = quotesSlice.actions

export const selectQuoteSearchText = ({ SalesEC }) => SalesEC.quotes.searchText
