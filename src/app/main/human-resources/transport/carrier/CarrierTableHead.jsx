...
import { delCarrierMulti } from '../store/carrierSlice'
...
const CarrierTableHead = (props) => {
  const dispatch = useDispatch()
  const numSelected = props.selectedCarrierIds.length
            ...
            >
              ...
              >
                <MenuList>
                  <MenuItem
                    onClick={() => {
                      dispatch(delCarrierMulti(props.selectedCarrierIds))
...
export default CarrierTableHead