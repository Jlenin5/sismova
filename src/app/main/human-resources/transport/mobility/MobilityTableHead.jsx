...
import { delMobMulti } from '../store/mobilitySlice'
...
const MobilityTableHead = (props) => {
  const dispatch = useDispatch()
  const numSelected = props.selectedMobIds.length
            ...
            >
              ...
              >
                <MenuList>
                  <MenuItem
                    onClick={() => {
                      dispatch(delMobMulti(props.selectedMobIds))
...
export default MobilityTableHead