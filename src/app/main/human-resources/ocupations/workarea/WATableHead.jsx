...
import { delWAMulti } from '../store/waSlice'

function WATableHead(props) {
  const dispatch = useDispatch()
  const numSelected = props.selectedWAIds.length
            ...
            >
              ...
              >
                <MenuList>
                  <MenuItem
                    onClick={() => {
                      dispatch(delWAMulti(props.selectedWAIds))
