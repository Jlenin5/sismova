...
import WATableHead from './WATableHead'
...
const WATable = (props) => {
  ...
  useEffect(() => {
    dispatch(getWorkAreas()).then(() => setLoading(false))
  }, [dispatch])
...
export default withRouter(WATable)