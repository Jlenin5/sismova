...
// import { removeRoles } from '../store/rolesSlice'
...
const RolTableHead = (props) => {

  const { selectedRolIds } = props
  const numSelected = selectedRolIds.length
          ...
          {numSelected > 0 && (
            ...
            >
              ...
              <Menu
                ...
                onClose={closeSelectedRolesMenu}
              >
                <MenuList>
                  <MenuItem
                    onClick={() => {
                      props.deleteMultiple(selectedRolIds)
                      // dispatch(removeRoles(selectedRolIds))
