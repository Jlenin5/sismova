...
import { delPermMulti } from '../store/permissionSlice'
...
const PermTableHead = (props) => {
  const dispatch = useDispatch()
  const numSelected = props.selectedPermissionIds.length
            ...
            >
              ...
              >
                <MenuList>
                  <MenuItem
                    onClick={() => {
                      dispatch(delPermMulti(props.selectedPermissionIds))
