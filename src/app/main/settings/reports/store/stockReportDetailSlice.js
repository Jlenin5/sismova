...
export const { selectAll: selectStockReport, selectById: selectStockReportById } =
  stockReportAdapter.getSelectors((state) => state.ReportsSC.stockReportDetail)
...
export const { setStockReportSearchText } = stockReportDetailSlice.actions

export const selectStockReportSearchText = ({ ReportsSC }) => ReportsSC.stockReportDetail.searchText
